CREATE OR REPLACE FUNCTION public.turnover_especificadores_migracao(p_inicio date, p_fim date, p_loja uuid DEFAULT NULL::uuid)
 RETURNS TABLE(especificador_id uuid, especificador_nome text, loja_origem_id uuid, loja_origem_nome text, loja_atual_id uuid, loja_atual_nome text, vendedor_origem_id uuid, vendedor_origem_nome text, vendedor_atual_id uuid, vendedor_atual_nome text, valor_antes numeric, valor_depois numeric, delta_pct numeric, migrou boolean, trocou_vendedor boolean)
 LANGUAGE plpgsql
