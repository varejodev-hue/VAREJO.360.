...
REVOKE ALL ON FUNCTION public.process_orcamentos_staging(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.process_orcamentos_staging(uuid) TO authenticated, service_role;